            ...
            <div class="collapse navbar-collapse" id="collapsibleNavId">
                ...
                <ul class="navbar-nav mb-1 ml-auto">
                    ...
                    <li class="nav-item giohang">
                        <a href="{{URL::to('/Giohang')}}" class="btn btn-secondary rounded-circle">
                            <i class="fa fa-shopping-cart"></i>
                            <div class="cart-amount">0</div>
                        </a>
                        <a class="nav-link text-dark giohang text-uppercase" href="{{URL::to('/Giohang')}}" style="display:inline-block">Giỏ Hàng</a>
                    </li>
                </ul>
            </div>
        </div>
                ...
                <div class="modal-body">
                    <form id="form-signin" class="form-signin mt-2">
                        ...
                        <div class="custom-control custom-checkbox mb-3">
                         ...
                         <a  href="{{URL::to('/login')}}"  class="btn btn-lg btn-block btn-signin text-uppercase text-white" type="submit"
                            style="background: #F5A623"> Đăng nhập</a>
                        <hr class="my-4">
            ...
            <div class="row justify">
                ...
                <div class="col-md-9">
                    <div class="benphai float-right">
                        ...
                        <a href="{{URL::to('/lienhe')}}" class="fas fa-comments-dollar">
                         Hỗ trợ trực tuyến </a>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-3" style="margin-right: -15px;">
                    ...
                    <div class="categorycontent">
                        <ul>
                            <li> <a href="{{URL::to('/SachKinhTe-KiNang')}}"> Sách Kinh Tế - Kỹ Năng</a><i class="fa fa-chevron-right float-right"></i>
                                <ul>
            ...
            <div class="noidung" style=" width: 100%;">
                <div class="row">
                    ...
                    <div class="col-12 d-flex justify-content-between align-items-center pb-2 bg-transparent pt-4">
                        ...
                        <a href="{{URL::to('/Sachmoituyenchon')}}" class="btn btn-warning btn-sm text-white">Xem tất cả</a>
                    </div>
                </div>
                <div class="khoisanpham" style="padding-bottom: 2rem;">
                    ...
                    <div class="card">
                        <a href="Lap-trinh-ke-hoach-kinh-doanh-hieu-qua.html" class="motsanpham"
                            ...
                            <div class="card-body noidungsp mt-3">
                                <h3 class="card-title ten"> <a href="{{URL::to('/Lap-Ke-Hoach-Kinh-Doanh-Hieu-Qua')}}">Lập Kế Hoạch Kinh Doanh Hiệu Quả </a></h3>
                    ...
                    <div class="card">
                        ...
                        Trí">
                            ...
                            <div class="card-body noidungsp mt-3">
                                <h3 class="card-title ten"> <a href="{{URL::to('/Ma-bun-luu-manh-va-nhung-cau-chuyen-khac-cua-nguyen-tri')}}">Ma Bùn Lưu Manh Và Những Câu Chuyện Khác Của Nguyễn
                                    Trí</a></h3>
                    ...
                    <div class="card">
                        <a href="#" class="motsanpham" style="text-decoration: none; color: black;"
                            ...
                            <div class="card-body noidungsp mt-3">
                                ...
                                <div class="gia d-flex align-items-baseline">
                                    <div class="giamoi">135.000 ₫</div>
                                    <div class="giacu text-muted">170.000 ₫</div>
                                    <div class="sale">-20%</div>
                                </div>
                                <div class="danhgia">
                                    <ul class="d-flex" style="list-style: none;">
                    ...
                    <div class="card">
                        <a href="#" class="motsanpham" style="text-decoration: none; color: black;"
                            ...
                            <div class="card-body noidungsp mt-3">
                                ...
                                <div class="gia d-flex align-items-baseline">
                                    <div class="giamoi">170.200 ₫</div>
                                    <div class="giacu text-muted">200.000 ₫</div>
                                    <div class="sale">-20%</div>
                                </div>
                                <div class="danhgia">
                                    <ul class="d-flex" style="list-style: none;">
