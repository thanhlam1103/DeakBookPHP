                    ...
                    <div class="dropdown">
                        <li class="nav-item account d-flex" type="button" class="btn dropdown" data-toggle="dropdown">
                            ...
                            <div class="info-logout">
                                <a class="nav-link text-dark text-uppercase username" href="{{URL::to('/login')}}">Khánh Nguyễn</a>
                                <a href="{{URL::to('/')}}" class="nav-link text-dark logout" href="{{URL::to('/')}}">Thoát <i class="fas fa-sign-out-alt"></i></a>
                            </div>
                        </li>
                    </div>
