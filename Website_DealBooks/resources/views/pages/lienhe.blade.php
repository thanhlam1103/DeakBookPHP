		...
		<div class="container">
			<div class="row">
				<div class="col-sm-12 col-lg-3">
					<div class="logo"><a href="index.html"><img src="images/logoo.png"></a></div>
				</div>
				<div class="col-sm-6">
				...
				<div class="col-sm-6 col-lg-3">
                    ...
                    <button class="submit_bt"><a href="{{URL::to('/')}}"><span class="doctor"><img src="images/doctor-icon.png"></span>Home</a></button>
				    </div>
				</div>
			</div>
		</div>
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-sm-6 col-md-6 col-lg-3">
					...
					<div class="map_flag"><img src="images/map-flag.png"><span class="padding-left">Bình Thạnh Tp Hồ Chí Minh</span></div>
					<div class="dolor_text"><img src="images/email-icon.png"><span class="padding-left">dealbook@gmail.com</span></div>
